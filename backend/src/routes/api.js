...
const pedidosSimpleController = require('../controllers/pedidosSimpleController');
...
// ========== GESTIÓN DE CLIENTES (CRÍTICO - FASE 1) ==========
// Usar archivo de rutas separado que ya existe
...
// ========== PEDIDOS SIMPLIFICADOS (TESTING Y DEMOSTRACION) ==========
router.post('/pedidos-simple', pedidosSimpleController.crearPedidoSimple);
router.get('/menu-disponible', pedidosSimpleController.obtenerMenuDisponible);
router.get('/mesas-pedidos', pedidosSimpleController.obtenerEstadoMesasParaPedidos);
