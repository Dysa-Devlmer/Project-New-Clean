...
async function crearPedido(req, res) {
    ...
    try {
        ...
        // VALIDACIÓN: empleado_vendedor_id es obligatorio
        const empleado_vendedor_id = id_empleado || 1; // Default: Administrador
        ...
        if (ventasAbiertas.length > 0) {
            ...
            `, [numero_venta, Num_Mesa, empleado_vendedor_id, id_terminal,
            ...
            await connection.query(`
                ...
                WHERE numero_mesa = ?
            `, [empleado_vendedor_id, comensales || 0, Num_Mesa]);
        }
