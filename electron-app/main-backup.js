    ...
    constructor() {
        ...
        this.config = {
            app: {
                ...
                environment: process.env.NODE_ENV || 'development'  // Cambiar a development por defecto
            },
    ...
    async createMainWindow() {
        ...
        try {
            ...
            const windowConfig = {
                ...
                webPreferences: {
                    nodeIntegration: true,          // Habilitar para funcionalidad completa
                    contextIsolation: false,        // Deshabilitar temporalmente para compatibilidad
                    enableRemoteModule: true,       // Habilitar para APIs completas
